...
export default function ShopValidator({
  ...
  const aprobadaTransferencia = async (
    datos: OnApproveData,
      ...
      <DeployContent>
            ...
            {stock > 0 ? (
              ...
              <div style={{ textAlign: "center" }}>
                ...
                <motion.div
                  ...
                  whileTap={{ scale: 0.8 }}
                >
                  <BotonConfirmar onClick={onClose}>Salir</BotonConfirmar>
                </motion.div>
              </div>
            )}
          </ContenedorPasos>
        ...
        {pasosValidacion === 3 && (
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.8 }}>
              <BotonConfirmar
                onClick={() => {
                  setPasosValidacion(4), setStock(stock - 1);
                }}
              >
                Siguiente
              </BotonConfirmar>
        ...
        {pasosValidacion === 4 && (
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.8 }}>
              <BotonConfirmar onClick={onClose}>Cerrar</BotonConfirmar>
            </motion.div>
          </ContenedorPasos>
        )}
      </DeployContent>
